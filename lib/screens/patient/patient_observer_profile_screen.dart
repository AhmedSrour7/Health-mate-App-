...
class PatientObserverProfilePage extends StatelessWidget {
  const PatientObserverProfilePage({super.key});
              ...
              children: [
                ...
                Container(
                  ...
                  child: CircleAvatar(
                    radius: 80,
                    backgroundImage:
                        NetworkImage(cubit.userModel!.observer!.pictureUrl!),
                  ),
                ),
                SizedBox(
                  height: 5,
                ...
                Text(
                  cubit.userModel?.observer?.firstName ?? "",
                          ...
                          child: Row(
                            children: [
                              ...
                              Expanded(
                                ...
                                hintText:
                                    cubit.userModel?.observer?.email ?? "",
                                labelText: "Email",
                                radius: 15,
                            ...
                            children: [
                              ...
                              Expanded(
                                  child: CustomTextFormField(
                                    ...
                                    controller: TextEditingController(),
                                hintText:
                                    cubit.userModel?.observer?.userName ?? "",
                                labelText: "Username",
                                radius: 15,
                                borderColor: Color(0xff199A8E),
                              ))
                            ...
                            children: [
                              ...
                              Expanded(
                                  child: CustomTextFormField(
                                    ...
                                    controller: TextEditingController(),
                                hintText:
                                    cubit.userModel?.observer?.phoneNumber ??
                                        "",
                                labelText: "Phone",
                                radius: 15,
                                borderColor: Color(0xff199A8E),
